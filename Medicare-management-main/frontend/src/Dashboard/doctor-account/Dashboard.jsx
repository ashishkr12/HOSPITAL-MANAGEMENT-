                      ...
                      tab === 'overview' && <div>
                        <div className='flex items-center gap-4 mb-10'>
                            <figure className='max-w-[200px] max-h-[200px]'>
                              <img src={data.photo} alt="profile-image" className='w-full' />
                            </figure>

                            <div>
                              <span className='bg-[#CCF0F3] text-irisBlueColor px-1 py-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold '>{data.specialization}</span>
                              ...
                              <div className='flex items-center gap-[6px]'>
                                  ...
                                  <span className='flex items-center text-textColor text-[14px] leading-5 lg:text-[16px] lg:leading-6 font-semibold '>
                                   {data.totalRating}
                                  </span>  
                              </div>
